...
**Module name:** :mod:`thewalrus_local.loop_hafnian_batch`

.. currentmodule:: thewalrus_local.loop_hafnian_batch
...
def loop_hafnian_batch(A, D, fixed_reps, N_cutoff, glynn=True):
    ...
    if oddmode is None:
        ...
        return _calc_loop_hafnian_batch_even(Ax, Dx, fixed_m_reps, batch_max, odd_cutoff, glynn=glynn)
