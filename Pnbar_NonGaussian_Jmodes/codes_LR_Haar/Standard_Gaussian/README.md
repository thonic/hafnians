...
```bash
cd CLUSTER_J2_Gaussian_squeezed_Haar && mkdir -p logs output && qsub submit_J2_Gaussian_squeezed_LR_Haar.slurm
cd CLUSTER_J4_Gaussian_squeezed_Haar && mkdir -p logs output && qsub submit_J4_Gaussian_squeezed_LR_Haar.slurm
```
