...
Usage
-----
    python run_parallel_J2_Kerr_squeezed_kappa_1_LR_Haar.py
    python run_parallel_J2_Kerr_squeezed_kappa_1_LR_Haar.py --workers 8
    qsub submit_J2_Kerr_squeezed_kappa_1_LR_Haar.slurm
"""
