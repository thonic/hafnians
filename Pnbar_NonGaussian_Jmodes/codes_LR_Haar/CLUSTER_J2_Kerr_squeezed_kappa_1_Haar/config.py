"""J=2 Kerr-squeezed state (kappa=1) — edit state parameters before qsub."""
...
RESULT_JSON = "Pnbar_J2_kerr_squeezed_kappa_1_LR.json"
RESULT_TXT = "Pnbar_J2_kerr_squeezed_kappa_1_LR.txt"
