"""J=4 Kerr-squeezed state — two active copies plus vacuum."""
...
SUMMARY_JSON = "Pnbar_J4_kerr_squeezed_LR_all_geometries.json"
SUMMARY_TXT = "Pnbar_J4_kerr_squeezed_LR_all_geometries.txt"
...
def result_json_name(geometry: str) -> str:
    return f"Pnbar_J4_kerr_squeezed_LR_geom{geometry}.json"


def result_txt_name(geometry: str) -> str:
    return f"Pnbar_J4_kerr_squeezed_LR_geom{geometry}.txt"
