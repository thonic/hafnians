"""
J=2 P(n̄) — Kerr-squeezed κ=1.0; parallel low-rank loop hafnian.
...
Usage
-----
    python run_parallel_J2_Kerr_squeezed_kappa_1_LR.py
    python run_parallel_J2_Kerr_squeezed_kappa_1_LR.py --workers 8
    qsub submit_J2_Kerr_squeezed_kappa_1_LR.slurm
"""
...
def run(
    *,
    ...
    print(f"  Hadamard  : {config.APPLY_HADAMARD}")
    ...
    b_mat, mu, scale, MK_dict = build_B_mu_scale(
        config.CP, J=J, apply_hadamard=config.APPLY_HADAMARD
    )
