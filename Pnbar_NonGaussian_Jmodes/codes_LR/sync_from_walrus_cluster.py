#!/usr/bin/env python3
"""
Build LR_Cluster_Codes folders from Walrus CLUSTER_* templates.

Folder names: CLUSTER_J2_even_cat_LR (same as CLUSTER_J2_even_cat + _LR).
Scripts: run_parallel_J2_even_cat_LR.py, submit_J2_even_cat_LR.slurm, etc.
"""
...
SPECS: list[dict] = [
    {
        ...
        "lr_dir": "CLUSTER_J2_superposition_LR",
        "run_script": "run_parallel_J2_superposition_LR.py",
        "submit": "submit_J2_superposition_LR.slurm",
        "pbs_name": "pnbar_J2_superposition_LR",
        "log": "logs/j2_superposition_LR.log",
        "j": 2,
    ...
    },
    {
        ...
        "lr_dir": "CLUSTER_J2_even_cat_LR",
        "run_script": "run_parallel_J2_even_cat_LR.py",
        "submit": "submit_J2_even_cat_LR.slurm",
        "pbs_name": "pnbar_J2_even_cat_LR",
        "log": "logs/j2_even_cat_LR.log",
        "j": 2,
    ...
    },
    {
        ...
        "lr_dir": "CLUSTER_J2_odd_cat_LR",
        "run_script": "run_parallel_J2_odd_cat_LR.py",
        "submit": "submit_J2_odd_cat_LR.slurm",
        "pbs_name": "pnbar_J2_odd_cat_LR",
        "log": "logs/j2_odd_cat_LR.log",
        "j": 2,
    ...
    },
    {
        ...
        "lr_dir": "CLUSTER_J4_even_cat_LR",
        "run_script": "run_parallel_J4_even_cat_LR.py",
        "submit": "submit_J4_even_cat_LR.slurm",
        "pbs_name": "pnbar_J4_even_cat_LR",
        "log": "logs/j4_even_cat_LR.log",
        "j": 4,
    },
    {
        "walrus_dir": "CLUSTER_J4_odd_cat",
        "lr_dir": "CLUSTER_J4_odd_cat_LR",
        "run_script": "run_parallel_J4_odd_cat_LR.py",
        "submit": "submit_J4_odd_cat_LR.slurm",
        "pbs_name": "pnbar_J4_odd_cat_LR",
        "log": "logs/j4_odd_cat_LR.log",
        "j": 4,
    },
]
...
def main() -> None:
    ...
    for spec in SPECS:
        sync_spec(spec)
    print("Done. LR_Cluster_Codes mirrors Walrus names with _LR suffix.")
