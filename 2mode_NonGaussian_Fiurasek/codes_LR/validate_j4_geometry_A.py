...
def check(folder: str) -> dict:
    here = ROOT / "LR_Cluster_Codes" / folder
    ...
    b_mat, mu, scale, MK = build_B_mu_scale(states, J=cfg.J, apply_hadamard=cfg.APPLY_HADAMARD)
...
def main() -> None:
    for folder in ("CLUSTER_J4_even_cat_LR", "CLUSTER_J4_odd_cat_LR"):
        print(check(folder))
