...
def run_kernel_check(lr_folder: str) -> dict:
    here = ROOT / "LR_Cluster_Codes" / lr_folder
    ...
    b_mat, mu, scale, MK = build_B_mu_scale(cfg.CP, J=cfg.J, apply_hadamard=cfg.APPLY_HADAMARD)
...
def compare_json(lr_folder: str, ref_path: Path, lr_json_name: str) -> dict:
    lr_path = ROOT / "LR_Cluster_Codes" / lr_folder / "output" / lr_json_name
