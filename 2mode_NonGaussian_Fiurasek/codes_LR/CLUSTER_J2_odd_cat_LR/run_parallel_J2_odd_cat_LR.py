...
Usage
-----
    python run_parallel_J2_even_cat_LR.py
    python run_parallel_J2_even_cat_LR.py --workers 8
    qsub submit_J2_even_cat_LR.slurm
"""
...
def run(
    *,
    ...
    for skip in getattr(config, "RAW_SKIP_NBARS", ()):
        raw.pop(skip, None)
